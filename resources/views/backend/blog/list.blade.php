                                        ...
                                        <tbody>
                                            @foreach ($blogs as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->title }}</td>
                                                    <td>{{ $item->blogDetail->category->name ?? 'No Category' }}</td>
                                                    <td>
                                                        <div class="badges">
                                                    ...
                                                    <td>
                                                        <div class="table_actions d-flex gap-2">
                                                            <a href="{{ route('admin.blog.edit', $item->id) }}" class="btn btn-outline-primary" alt="Edit" title="Edit"><i class="far fa-edit"></i></a>
                                                            <a href="#!" class="btn btn-outline-danger" data-del="{{ route('admin.blog.delete', $item->id) }}" data-bs-toggle="modal" data-bs-target="#blog_delete_modal" data-id="{{ $item->id }}" data-name="{{ $item->title }}" alt="Delete" title="Delete"><i class="far fa-trash-alt"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5> Are you sure you want to delete this Blog List?</h5>
                </div>
