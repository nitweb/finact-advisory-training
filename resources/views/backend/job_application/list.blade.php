                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="table_actions">
                                                                <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#jobApplicationModal" data-interest="{{ jobPost()->find($item->interested_in)->title ?? 'N/A' }}" data-message="{{ $item->message }}">
...
@section('footer_script')
    <script>
        ...
        jobApplicationModal.addEventListener('show.bs.modal', function(event) {
            ...
            var modalSubject = jobApplicationModal.querySelector('#modal-subject');
            var modalMessage = jobApplicationModal.querySelector('#modal-message');
