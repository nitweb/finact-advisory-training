                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h4>{{ $title }}</h4>
                                <h4>
                                    <a href="{{ route('admin.service-sub-category.add') }}" class="btn btn-outline-primary"><i class="fas fa-plus"></i> Add</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                        ...
                                        <tbody>
                                            @foreach ($service_sub_categories as $key => $item)
                                                <tr>
                                                    <td>{{ $service_sub_categories->count() - $key }}</td>
                                                    <td>{{ $item->name }}</td>
                                                    <td>{{ $item->category->name }}</td>
                                                    <td>
                                                        <div class="table_actions">
                                                            <a href="{{ route('admin.service-sub-category.edit', $item->id) }}" class="btn btn-outline-primary" alt="Edit" title="Edit"><i class="far fa-edit"></i></a>
