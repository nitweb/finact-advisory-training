...
@section('admin_content')
    ...
    {{-- Delete Modal --}}
    <div class="modal fade" id="service_delete_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5> Are you sure you want to delete this Service List?</h5>
                </div>
...
@section('footer_script')
    <script>
        $('#service_delete_modal').on('show.bs.modal', function(event) {
