                            ...
                            <div class="card-body">
                                ...
                                <form id="form" action="{{ route('admin.slider.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate>
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-md-8">
                                            <label class="col-form-label">Image [1600px by 700px]</label>
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control @error('short_description') is-invalid @enderror" name="short_description" value="{{ old('short_description') }}" data-parsley-required-message="Slider Short Description is required*" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" value="{{ old('link') }}" data-parsley-required-message="Slider Link is required*" required>
                                        </div>
                                    </div>
