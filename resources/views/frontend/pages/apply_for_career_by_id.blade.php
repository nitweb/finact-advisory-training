                                ...
                                <form novalidate="" class="register-form" id="registerform" method="post" action="{{ route('admin.job_apply.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="billing">
                                                ...
                                                <select class="dropdown_sort" name="interested_in" required>
                                                    ...
                                                    @if (jobPost()->count() > 0)
                                                        @foreach (jobPost() as $job)
                                                            <option value="{{ $job->id }}" {{ isset($career_apply) && $career_apply->id == $job->id ? 'selected' : '' }}>
                                                                {{ $job->title }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="flat-bill">
                                            ...
                                            <p class="text-muted mt-3" style="font-size: 14px; color: rgb(23, 162, 184) !important;">accept jpeg, png, jpg, webp &amp; pdf only</p>
                                        </div>
