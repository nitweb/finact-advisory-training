...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .letterhead .brand-col { display: table-cell; vertical-align: middle; width: 60%; }
        .letterhead .meta-col { display: table-cell; vertical-align: middle; width: 40%; text-align: right; }

        .brand-logo { max-height: 46px; max-width: 220px; margin-bottom: 8px; }
        .brand-name { font-size: 19px; font-weight: bold; color: #163355; letter-spacing: 0.2px; }
        .brand-tagline { font-size: 10.5px; color: #8a93a3; margin-top: 2px; }
        .brand-contact { font-size: 9.5px; color: #6b7280; margin-top: 8px; line-height: 1.6; }
        ...
        .status-paid { background: rgba(34, 153, 84, 0.12); color: #1e8449; }
        .status-pending { background: rgba(184, 152, 103, 0.18); color: #9a7d4e; }
        .status-other { background: #f0f4f9; color: #163355; }
        ...
        .info-panel .info-col + .info-col { border-left: 1px solid #eef1f6; }
        ...
        .info-panel p { font-size: 12px; line-height: 1.85; color: #2b3648; }
        .info-panel p strong { color: #163355; }
        ...
        .item-title { font-weight: bold; color: #163355; }

        /* ── Totals ── */
        table.totals { width: 100%; border-collapse: collapse; margin-top: 14px; }
        table.totals td { padding: 7px 12px; font-size: 12.5px; }
        table.totals td.label { text-align: right; color: #6b7280; width: 82%; }
        table.totals td.value { text-align: right; color: #2b3648; width: 18%; white-space: nowrap; }
        ...
        table.totals tr.grand td.label { color: #163355; }
        ...
        .thanks .thanks-title { font-size: 13px; font-weight: bold; color: #163355; margin-bottom: 4px; }
        .thanks .thanks-note { font-size: 10.5px; color: #8a93a3; }
        ...
        .footer-strip span { color: #d8c39a; }
    </style>
</head>
<body>
    <div class="sheet">
        ...
        <div class="letterhead">
            <div class="brand-col">
                ...
                <div class="brand-contact">
                    @if (siteSetting() && siteSetting()->site_address) {{ siteSetting()->site_address }}<br>@endif
                    @if (siteSetting() && siteSetting()->site_phone) Phone: {{ siteSetting()->site_phone }} &nbsp;|&nbsp; @endif
                    @if (siteSetting() && siteSetting()->site_email) {{ siteSetting()->site_email }} @endif
                </div>
            </div>
            <div class="meta-col">
